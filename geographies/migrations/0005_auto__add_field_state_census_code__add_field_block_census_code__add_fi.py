...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.census_code'
        db.add_column(u'geographies_state', 'census_code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Block.census_code'
        db.add_column(u'geographies_block', 'census_code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'District.census_code'
        db.add_column(u'geographies_district', 'census_code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Village.census_code'
        db.add_column(u'geographies_village', 'census_code',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.census_code'
        db.delete_column(u'geographies_state', 'census_code')

        # Deleting field 'Block.census_code'
        db.delete_column(u'geographies_block', 'census_code')

        # Deleting field 'District.census_code'
        db.delete_column(u'geographies_district', 'census_code')

        # Deleting field 'Village.census_code'
        db.delete_column(u'geographies_village', 'census_code')
    ...
    models = {
        ...
        u'geographies.block': {
            ...
            'census_code': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
        ...
        u'geographies.village': {
            ...
            'census_code': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
