...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QaCocoUser.village'
        db.delete_column(u'qacoco_qacocouser', 'village_id')


    def backwards(self, orm):
        # Adding field 'QaCocoUser.village'
        db.add_column(u'qacoco_qacocouser', 'village',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['geographies.Village']),
                      keep_default=False)
