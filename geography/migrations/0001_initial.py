...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'geography_country', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_country_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_country_related_modified', null=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'geography', ['Country'])

        # Adding model 'Region'
        db.create_table(u'geography_region', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_region_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_region_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
        ...
        db.send_create_signal(u'geography', ['Region'])

        # Adding model 'State'
        db.create_table(u'geography_state', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_state_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_state_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('state_name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.Region'])),
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.Country'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'geography', ['State'])

        # Adding model 'District'
        db.create_table(u'geography_district', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_district_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_district_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('district_name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.State'])),
        ...
        db.send_create_signal(u'geography', ['District'])

        # Adding model 'Block'
        db.create_table(u'geography_block', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_block_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_block_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('block_name', self.gf('django.db.models.fields.CharField')(unique='True', max_length=100)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.District'])),
        ))
        db.send_create_signal(u'geography', ['Block'])

        # Adding model 'Village'
        db.create_table(u'geography_village', (
            ('user_created', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_village_created', null=True, to=orm['auth.User'])),
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('user_modified', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'geography_village_related_modified', null=True, to=orm['auth.User'])),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('old_coco_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('village_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('block', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.Block'])),
            ('no_of_households', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('population', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('road_connectivity', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('control', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'geography', ['Village'])

        # Adding unique constraint on 'Village', fields ['village_name', 'block']
        db.create_unique(u'geography_village', ['village_name', 'block_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Village', fields ['village_name', 'block']
        db.delete_unique(u'geography_village', ['village_name', 'block_id'])

        # Deleting model 'Country'
        db.delete_table(u'geography_country')

        # Deleting model 'Region'
        db.delete_table(u'geography_region')

        # Deleting model 'State'
        db.delete_table(u'geography_state')

        # Deleting model 'District'
        db.delete_table(u'geography_district')

        # Deleting model 'Block'
        db.delete_table(u'geography_block')

        # Deleting model 'Village'
        db.delete_table(u'geography_village')
