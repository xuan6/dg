...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for i in range(0, dashboard_screening.count()/chunk + 1):
            ...
            Screening.objects.bulk_create([Screening(old_coco_id=x.id, date=x.date, start_time=x.start_time,
                                                     ...
                                                     village=orm['geography.Village'].objects.get(old_coco_id=x.village_id),
