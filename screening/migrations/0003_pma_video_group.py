...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Screening = orm['screening.Screening']
        ...
        for i in range(0, dashboard_PMA.count()/chunk + 1):
            ...
            print "PMA %d" % (i*chunk)
            PMA.objects.bulk_create([PMA(old_coco_id=x.id, screening = Screening.objects.get(old_coco_id=x.screening_id),
                                         ...
                                         expressed_adoption_video=None if x.expressed_adoption_video_id is None else orm['video.Video'].objects.get(old_coco_id=x.expressed_adoption_video_id)) 
    ...
    complete_apps = ['dashboard', 'screening']
    symmetrical = True
