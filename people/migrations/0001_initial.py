...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'people_animator', (
            ...
            ('village', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.Village'], null=True, blank=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geography.District'], null=True, blank=True)),
