...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        Assigned.objects.bulk_create([Assigned(animator_id=Animator.objects.get(old_coco_id=x.animator_id), village_id=Village.objects.get(old_coco_id=x.village_id), start_date=x.start_date) for x in orm['dashboard.Animator'].assigned_villages.through.objects.all()])
