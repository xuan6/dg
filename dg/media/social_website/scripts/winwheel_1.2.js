...
var wheelImageName   = "../../media/assets/images/new.png";	// File name of the image for the wheel.
var spinButtonImgOn  = "../../media/assets/images/spin_on.png";		// Name / path to the images for the spin button.
var spinButtonImgOff = "../../media/assets/images/spin_off.png";
...
prizes[0] = {"name" : "Discover Page", "url" :"/discover", "startAngle" : 0,   "endAngle" : 89};  // Note how prize end angle is 1 less than start angle of next prize so no overlap.
prizes[1] = {"name" : "Home Page", "url" :"", "startAngle" : 90,  "endAngle" : 179};
prizes[2] = {"name" : "About Us", "url" :"/about", "startAngle" : 180,  "endAngle" : 269};
prizes[3] = {"name" : "Partner Page", "url" :"/connect", "startAngle" : 270, "endAngle" : 360};
//prizes[4] = {"name" : "Discover Page", "startAngle" : 180, "endAngle" : 224};
//prizes[5] = {"name" : "Connect Page", "startAngle" : 225, "endAngle" : 269};
//prizes[6] = {"name" : "Annual Report", "startAngle" : 270, "endAngle" : 314};
//prizes[7] = {"name" : "Collections View Page", "stanrtAngle" : 315, "endAngle" : 360};
		...
		if ((doPrizeDetection) && (prizes))
		{
			...
			for (x = 0; x < (prizes.length); x ++)
			{
				if ((relativeAngle >= prizes[x]['startAngle']) && (relativeAngle <= prizes[x]['endAngle']))
				{
					...
					window.location = "http://digitalgreen.org" + prizes[x]['url'];
					break;
				}
			}
		}
