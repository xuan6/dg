...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonAdoptPractice.old_coco_id'
        db.add_column(u'adoptions_personadoptpractice', 'old_coco_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonAdoptPractice.old_coco_id'
        db.delete_column(u'adoptions_personadoptpractice', 'old_coco_id')
