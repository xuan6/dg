...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideoFile.file_name'
        db.add_column('social_website_videofile', 'file_name',
                      self.gf('django.db.models.fields.CharField')(default=' ', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideoFile.file_name'
        db.delete_column('social_website_videofile', 'file_name')
