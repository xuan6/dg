...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_website_videofile', (
        ...
        db.send_create_signal('social_website', ['VideoFile'])

        # Deleting field 'VideoChunk.file_name'
        db.delete_column('social_website_videochunk', 'file_name')

        # Adding field 'VideoChunk.video_file'
        db.add_column('social_website_videochunk', 'video_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='0', to=orm['social_website.VideoFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VideoFile'
        db.delete_table('social_website_videofile')

        # Adding field 'VideoChunk.file_name'
        db.add_column('social_website_videochunk', 'file_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Deleting field 'VideoChunk.video_file'
        db.delete_column('social_website_videochunk', 'video_file_id')
    ...
    models = {
        ...
        'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 1, 0, 0)'}),
        ...
        'social_website.crontimestamp': {
            ...
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 1, 0, 0)'}),
        ...
        'social_website.videochunk': {
            ...
            'chunk_number': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video_file': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['social_website.VideoFile']"})
        },
        'social_website.videofile': {
