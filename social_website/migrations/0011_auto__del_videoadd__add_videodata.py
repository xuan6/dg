...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_website_videodata', (
        ...
        db.send_create_signal('social_website', ['VideoData'])
    ...
    def backwards(self, orm):
        ...
        db.create_table('social_website_videoadd_video_chunk', (
            ...
            ('videoadd', models.ForeignKey(orm['social_website.videoadd'], null=False)),
            ('videochunk', models.ForeignKey(orm['social_website.videochunk'], null=False))
        ))
        db.create_unique('social_website_videoadd_video_chunk', ['videoadd_id', 'videochunk_id'])

        # Deleting model 'VideoData'
        db.delete_table('social_website_videodata')
    ...
    models = {
        ...
        'social_website.comment': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 6, 0, 0)'}),
        ...
        'social_website.crontimestamp': {
            ...
            'last_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 6, 0, 0)'}),
