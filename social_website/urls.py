...
from views import social_home, collection_view, partner_view, search_view, collection_add_view, collection_edit_view, video_view, resource_view, picoseekho_view, upload_subtitles_view
...
urlpatterns = patterns('',
    ...
    url(r'^subtitle/upload/$', upload_subtitles_view, name='create_collection'),
